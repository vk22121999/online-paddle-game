...
var  ballY = getRandomArbitrary(100,500);
 ...
 function calculateMousePos(evt)
 {
      ...
      var framesPerSecond = 30;
        ...
        function(evt){
          ...
          window.addEventListener('keyup',
            ...
            {
              if(event.keyCode===32)
                {flag=true;yourScore=compScore=0;}
  ...
  {   
     ...
     ballSpeedX = -10;ballSpeedY = getRandomArbitrary(-2,5);
    ...
    //console.log(ballX);  
     ...
     colorRect(canvas.width-PADDLE_THICKNESS,paddle2Y,PADDLE_THICKNESS,PADDLE_HEIGHT,'white');
           ...
           { canvasContext.font = "20px Verdana";
              canvasContext.fillText("Retry,press space bar to play",(canvas.width/2)-130,canvas.height/2);
           }
